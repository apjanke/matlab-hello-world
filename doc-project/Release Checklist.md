# matlab-hello-world Release Checklist
...
* Update the installation instructions in README to use the upcoming new release tarball URL.
  * Format is: `https://github.com/apjanke/matlab-hello-world/releases/download/v<version>/matlab-hello-world-<version>.tar.gz`
* Regenerate the doco
  * `make doc`

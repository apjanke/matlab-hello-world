function hello_make_release(newVersion)
% Cut a release of matlab-hello-world
%
% hello_make_release newVersion
%
...
echo("   https://github.com/apjanke/matlab-hello-world/releases")
if ismac
  % TODO: Figure out how to do this on Windows and Linux
  system('open "https://github.com/apjanke/matlab-hello-world/releases"')
end
